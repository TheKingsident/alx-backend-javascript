...
describe('calculateNumber', function() {
    ...
    it('should return the sum of a positive and a negative rounded number', function() {
        assert.equal(calculateNumber(1.4, -2.6), -2);
        assert.equal(calculateNumber(1.6, -2.4), 0);
    });
